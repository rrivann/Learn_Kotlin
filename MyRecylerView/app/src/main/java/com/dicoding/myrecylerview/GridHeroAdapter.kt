...
class GridHeroAdapter(val listHero: ArrayList<Hero>) :
    ...
    override fun onBindViewHolder(holder: GridViewHolder, position: Int) {
        Glide.with(holder.itemView.context).load(listHero[position].photo).apply(RequestOptions())
            .override(350, 550)
    ...
    override fun getItemCount(): Int {
        return listHero.size//To change body of created functions use File | Settings | File Templates.
    }
